...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2018 at 07:31 AM
...
INSERT INTO `a_submit` (`post_id`, `username`, `idea`, `description`, `image`, `latitude`, `longitude`, `status`, `district`, `state`, `pincode`, `project_budget`, `equipments`, `_procedure`, `date_time`, `upvotes`, `policy`, `policy_organization`, `policy_details`) VALUES
(4, '3', ' Irrigation Scheduling', 'A effective method to conserve water.', 'pexels-photo-312105.jpg', 22.5726, 88.3639, 1, 'Kolkata', 'West Bengal', 700028, 'Rs 1Lac', '16mm main supply line pipe - 25 mtrs\r\n4mm feeder line pipe - 50 mtrs\r\nDrip emitters - 100 nos\r\nFeeder to main supply line connectors - 100 nos\r\nEmitter stakes - 100 nos\r\nDummy - 20nos(For closing any unwanted hole in main supply line)\r\nElbow connector - 15 nos\r\nT connector - 8 nos\r\nStraight connector with tap - 5(stop supply to particular line)\r\nStraight connector - 5\r\nUniversal water tap adapter - 1\r\nEnd cap - 12\r\nDrip hole punch - 1(tool to make hole in main supply pipe)', 'Smart water management is not just about how water is delivered but also when, how often, and how much. To avoid under- or over watering their crops, farmers carefully monitor the weather forecast, as well as soil and plant moisture, and adapt their irrigation schedule to the current conditions. Tory Farms, which uses flood irrigation in their orchards , waters at night to slow down evaporation, allowing water to seep down into the soil and replenish the water table. ', '2018-03-20 10:15:00', 0, '', '', ''),
(5, '1', 'Rainwater Harvesting', ' Capturing and Storing Water, to use it in times of need and avoid wastage of water.', 'pexels-photo-287229.jpg', 11.8745, 75.3704, 1, 'Kannur', 'Kerala', 670650, 'Rs50,000 approx. ', 'Catchments\r\nCoarse Mesh\r\nGutters\r\nConduits\r\nFirst-Flushing\r\nFilter\r\n', 'Many farms rely on municipal water or wells (groundwater), while some have built their own ponds to capture and store rainfall for use throughout the year. Properly managed ponds can also create habitat for local wildlife. Marin Roots Farm relies on two ponds for all of their water needs, helping to minimize their impact on the surrounding watershed. ', '0000-00-00 00:00:00', 0, '', '', ''),
