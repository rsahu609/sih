            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="form-row form">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div>
                                        ...
                                        <input type="radio" name="policy_radio" value="radio_true" id="yes" checked disabled>
                                        <label for="no">No </label>
                                        <input type="radio" name="policy_radio" value="radio_false" id="no" disabled>
                                    </div>
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="state" value="Meghalaya">
                    ...
                    <div class="map-container" style="padding: 10px;">
                        <div id="map{{post_id}}" style="width: auto; height:500px;margin:auto;"></div>
                    </div>
